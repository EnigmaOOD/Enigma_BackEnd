...
SECRET_KEY = 'django-insecure-#&t%e9y+z*85#h3!@+r%lhvh%@($-t6vs_pi9ed#$8&)cf^%ck'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
#'fatemehshafiei.pythonanywhere.com'
ALLOWED_HOSTS = ['localhost', 'all']
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/", # Local Link provided by the redis-server command
        "OPTIONS": {
